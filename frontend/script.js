document.addEventListener("DOMContentLoaded", () => {
  ...
  const products = [
    {
      ...
      description: "Burger lezat dengan daging sapi premium dan sayuran segar",
    },
    {
      name: "Pasta",
      price: 35000,
      image: "image/pasta.jpg",
      description: "Pasta Italia dengan saus bolognese yang kaya rasa",
    },
    {
      name: "Lasagna",
      price: 45000,
      image: "image/lasagna.webp",
      description: "Lasagna berlapis dengan keju mozzarella dan daging cincang",
    },
    {
      name: "Chocolate Drink",
      price: 25000,
      image: "image/chocolate_Drink.jpg",
      description: "Minuman coklat hangat dengan whipped cream",
    },
    {
      name: "Pizza",
      price: 55000,
      image: "image/pizza.jpg",
      description: "Pizza margherita dengan keju mozzarella dan basil segar",
    },
    {
      name: "Hot Dog",
      price: 30000,
      image: "image/Hot_dog.jpg",
      description: "Hot dog dengan sosis premium dan saus mustard",
    },
    {
      name: "Fresh Juice",
      price: 20000,
      image: "image/juse.jpg",
      description: "Jus buah segar pilihan dengan vitamin tinggi",
    },
    {
      name: "Biryani",
      price: 40000,
      image: "image/biryani.webp",
      description: "Nasi biryani dengan daging kambing dan rempah-rempah",
    },
    {
      name: "Chocolate Cake",
      price: 35000,
      image: "image/chocolate.jpg",
      description: "Kue coklat lembut dengan frosting coklat premium",
    },
    {
      name: "Ice Cream",
      price: 18000,
      image: "image/ice_cream.jpg",
      description: "Es krim vanilla dengan topping coklat dan kacang",
    },
    {
      name: "Spaghetti",
      price: 38000,
      image: "image/Spanchi.jpg",
      description: "Spaghetti carbonara dengan bacon dan keju parmesan",
    },
    {
      name: "Sandwich",
      price: 28000,
      image: "image/sandwich.jpg",
      description: "Sandwich club dengan ayam, bacon, dan sayuran segar",
    },
  ]
  ...
  if (orderBtn) {
    orderBtn.addEventListener("click", (e) => {
      ...
      const orderName = document.querySelector("input[placeholder='food name']")
      ...
      if (!orderName.value) {
        showError(orderName, "Nama makanan/minuman wajib diisi.")
        isValid = false
      }
      ...
      alert("Terima kasih " + orderData.name + ", pesanan Anda telah dikirim!")
